...
import { providers, transactions, InMemorySigner, Connection, Account } from 'near-api-js';
import { KeyPair, serialize as serialize$1 } from 'near-api-js/lib/utils';
...
class MyNearWalletConnector {
  ...
  completeTransaction({
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const blockHash = serialize$1.base_decode(block.header.hash);
      // create Transaction for the wallet
      return transactions.createTransaction(this.signedAccountId, KeyPair.fromRandom("ed25519").getPublicKey(), receiverId, 0, actions.map(a => createAction(a)), blockHash);
    });
  }
  ...
  signUsingKeyPair({
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const signer = yield InMemorySigner.fromKeyPair(this.network.networkId, this.signedAccountId, keyPair);
  ...
  requestSignTransactionsUrl(txs) {
    ...
    newUrl.searchParams.set("transactions", txs.map(transaction => borsh.serialize(SCHEMA.Transaction, transaction)).map(serialized => Buffer.from(serialized).toString("base64")).join(","));
