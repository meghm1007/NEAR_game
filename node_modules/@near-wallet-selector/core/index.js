...
var safeGetBuiltIn$1 = function (name) {
  if (!DESCRIPTORS$6) return globalThis$g[name];
  var descriptor = getOwnPropertyDescriptor(globalThis$g, name);
...
if (!microtask$1) {
  ...
  // - setTimeout
    ...
    macrotask = bind$4(macrotask, globalThis$f);
    notify$1 = function () {
      macrotask(flush);
    };
  }
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$7(globalThis$d.PromiseRejectionEvent);
...
var onUnhandled = function (state) {
  call$c(task, globalThis$c, function () {
...
class WalletModules {
  ...
  setup() {
    return __awaiter(this, void 0, void 0, function* () {
      yield Promise.all(this.factories.map((factory, i) => factory({
        options: this.options
